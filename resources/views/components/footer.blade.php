<footer class="bg-white">
    ...
    <div class="px-4 py-6 bg-gray-100 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-500 sm:text-center">&copy; 2025<a href="#"> ROARX </a>Semua Hak Dilindungi.
        </span>
        <div class="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
              ...
              <a href="https://github.com/mahayasa1/" class="text-gray-400 hover:text-gray-900">
