<x-layout_admin>
    ...
    <div class="px-6 pt-16 lg:px-8">
        <div class="mx-auto max-w-2xl px-4 py-8">
            {{-- <h2 class="text-2xl font-bold text-gray-900 mb-6">Add New Bike</h2> --}}

            <form action="{{ route('bikes.store') }}" method="POST" class="space-y-4 border border-gray-300 rounded-lg p-6 bg-white" enctype="multipart/form-data">
                @csrf
                <div>
